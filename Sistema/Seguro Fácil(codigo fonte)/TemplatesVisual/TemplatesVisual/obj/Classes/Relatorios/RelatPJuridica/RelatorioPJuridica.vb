...
Public Class RelatorioPJuridica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SeguroFacil.RelatorioPJuridica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRelatorioPJuridica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RelatorioPJuridica = New RelatorioPJuridica()
        rpt.Site = Me.Site
        Return rpt
    End Function
