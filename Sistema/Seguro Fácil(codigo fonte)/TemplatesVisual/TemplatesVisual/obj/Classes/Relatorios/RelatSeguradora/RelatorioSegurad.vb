...
Public Class RelatorioSegurad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SeguroFacil.RelatorioSegurad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRelatorioSegurad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RelatorioSegurad = New RelatorioSegurad()
        rpt.Site = Me.Site
        Return rpt
    End Function
