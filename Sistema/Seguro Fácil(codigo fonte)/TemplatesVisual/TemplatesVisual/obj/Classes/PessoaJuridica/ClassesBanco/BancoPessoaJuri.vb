Public Class BancoPessoaJuri
    ...
    Public Sub New(RazaoSocial As String, NomeFantasia As String, Representante As String, CNPJ As String, AreaAtuacao As String, Site As String, Comentarios As String, Status As String)
