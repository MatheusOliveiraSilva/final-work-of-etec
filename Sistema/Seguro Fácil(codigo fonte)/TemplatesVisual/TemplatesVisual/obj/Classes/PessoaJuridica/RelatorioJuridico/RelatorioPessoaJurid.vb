...
Public Class RelatorioPessoaJurid
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RelatorioPessoaJurid.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SeguroFacil.RelatorioPessoaJurid.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Coloque_o_código_da_pessoa_juridica() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRelatorioPessoaJurid
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RelatorioPessoaJurid = New RelatorioPessoaJurid()
        rpt.Site = Me.Site
        Return rpt
    End Function
