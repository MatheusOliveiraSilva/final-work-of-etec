...
Public Class RelatorioMontagemApolice
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RelatorioMontagemApolice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SeguroFacil.RelatorioMontagemApolice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Id_da_apolice() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRelatorioMontagemApolice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RelatorioMontagemApolice = New RelatorioMontagemApolice()
        rpt.Site = Me.Site
        Return rpt
    End Function
