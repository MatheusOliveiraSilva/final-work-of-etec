Public Class UpdateOrcamentoOrc
    ...
    Public Sub New(DataCalculo As String, VigeIni As String, VigeFim As String, Premio As String, franquia As String, cobertura As String, DnMtr As String, DnCorp As String,
                   appMorte As String, appinval As String, dnMoral As String, ass24Horas As String, Vidros As String, CarReserv As String, Comentarios As String, NomeSeg As String, CI As String, PercComissao As String)
