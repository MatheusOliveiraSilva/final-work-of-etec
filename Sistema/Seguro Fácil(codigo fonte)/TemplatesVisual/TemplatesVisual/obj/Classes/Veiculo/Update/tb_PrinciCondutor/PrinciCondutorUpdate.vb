Public Class PrinciCondutorUpdate
    ...
    Public Sub New(especifique As String, IdPessoaFisica As String, IdPessoJuridica As String, IdQuestionario As String, PrincipalReside As String)
