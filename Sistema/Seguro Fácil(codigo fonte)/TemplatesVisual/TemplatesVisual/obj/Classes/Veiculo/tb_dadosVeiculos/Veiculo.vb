Public Class Veiculo
    ...
    Public Sub New(Fabricante As String, Modelo As String, Placa As String, Renavan As String, Chassi As String, Financiamento As String, CorVeiculo As String, qtda_portas As String, Combustivel As String, KitGas As String, IdQuestao As String, IdPessoaFisica As String, IdPessoaJuridica As String, AntFurto As String, AnoFabric As String)
