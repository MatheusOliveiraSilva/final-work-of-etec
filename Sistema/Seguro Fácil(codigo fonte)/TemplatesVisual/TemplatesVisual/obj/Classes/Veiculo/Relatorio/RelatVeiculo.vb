...
Public Class RelatVeiculo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SeguroFacil.RelatVeiculo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Coloque_o_id_do_questionario() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRelatVeiculo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RelatVeiculo = New RelatVeiculo()
        rpt.Site = Me.Site
        Return rpt
    End Function
