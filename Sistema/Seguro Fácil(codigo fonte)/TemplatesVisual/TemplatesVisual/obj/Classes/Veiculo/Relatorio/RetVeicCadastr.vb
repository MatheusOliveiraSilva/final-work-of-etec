...
Public Class RetVeicCadastr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SeguroFacil.RetVeicCadastr.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_id_do_cliente() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRetVeicCadastr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RetVeicCadastr = New RetVeicCadastr()
        rpt.Site = Me.Site
        Return rpt
    End Function
