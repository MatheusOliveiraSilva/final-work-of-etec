...
Public Class ReciboRelat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SeguroFacil.ReciboRelat.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Digite_o_ID_da_comissão() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReciboRelat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReciboRelat = New ReciboRelat()
        rpt.Site = Me.Site
        Return rpt
    End Function
