...
Public Class RelatorioSinistr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SeguroFacil.RelatorioSinistr.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_id_do_Sinistro() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRelatorioSinistr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RelatorioSinistr = New RelatorioSinistr()
        rpt.Site = Me.Site
        Return rpt
    End Function
